...
export default function Admin() {
    ...
    const [backgroundColorInput, setBackgroundColorInput] = useState('#f1f1ff1');
    const [textColorInput, setTextColorInput] = useState('#f1f1ff1');
    ...
    return (
        <div className="admin-container">
            ...
            <form className='form' onSubmit={handleRegister}>
                ...
                <label className='label right'>Nome do link</label>
                <Input
                    placeholder="Nome do link..."
                    value={nameInput}
                    onChange={(e) => setNameInput(e.target.value)}
                />
                <label className='label right'>Url do link</label>
                <Input
                    type="url"
